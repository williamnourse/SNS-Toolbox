...
for num in range(numSamples):
    ...
    for i in range(len(t)):
        print('Spiking Sparse. %i Neurons Numpy Step %i/%i'%(numNeurons[num],i+1,len(t)))
        stepStart = time.time()
    ...
    for i in range(len(t)):
        print('Spiking Sparse. %i Neurons Torch CPU Step %i/%i'%(numNeurons[num],i+1,len(t)))
        stepStart = time.time()
    ...
    try:
        ...
        # print('GPU Memory Allocated: %d , Reserved: %d' % (torch.cuda.memory_allocated(), torch.cuda.memory_reserved()))
        for i in range(len(t)):
            print('Spiking Sparse. %i Neurons Torch GPU Step %i/%i'%(numNeurons[num],i+1,len(t)))
            stepStart = time.time()
    ...
    try:
        ...
        # print('GPU Memory Allocated: %d , Reserved: %d' % (torch.cuda.memory_allocated(), torch.cuda.memory_reserved()))
        for i in range(len(t)):
            print('Spiking Sparse. %i Neurons Torch Sparse CPU Step %i/%i'%(numNeurons[num],i+1,len(t)))
            stepStart = time.time()
    ...
    try:
        ...
        # print('GPU Memory Allocated: %d , Reserved: %d' % (torch.cuda.memory_allocated(), torch.cuda.memory_reserved()))
        for i in range(len(t)):
            print('Spiking Sparse. %i Neurons Torch Sparse GPU Step %i/%i'%(numNeurons[num],i+1,len(t)))
            stepStart = time.time()
            _ = torchGPUSparseModel.forward(torchGPUSparseInput)
            stepStop = time.time()
    ...
    for i in range(len(t)):
        print('Spiking Sparse. %i Neurons Manual Step %i/%i' % (numNeurons[num], i + 1, len(t)))
        stepStart = time.time()
    ...
    pickle.dump(data, open('dataJetsonNanoSpikingSparse.p', 'wb'))
