...
for num in range(numSamples):
    ...
    with nengo.Network() as model:
        layer = nengo.Node(
            SpikingNeuronsWithSynapticInput(num_neurons, npModel.c_m, npModel.g_max_spike, npModel.del_e, 1,-1, bias=[current], R=20))
    ...
    pickle.dump(data, open('../../backendSpeed/dataNengoTimesSpikingDense.p', 'wb'))
