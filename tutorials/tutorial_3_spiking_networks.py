...
net.addInput(name='I0', color='black')
...
net_pop.addInput(name='I1',color='black')
net_pop.addInputConnection(1,'I1','Source')
net_pop.addSynapse(synapse_spike,'Source','Destination')
net_pop.addOutput('Source',name='O6S',color='grey',spiking=True)
net_pop.addOutput('Destination',name='O7S', color='grey', spiking=True)
